...
const loadCard = (id, image, name, description, category, price) => {
    ...
    cardContainer.innerHTML += `
        <div id="card-${id}" class="card p-3 sm:p-4 flex flex-col rounded-lg bg-white">
            ...
            <div class="badge badge-soft badge-success bg-[#DCFCE7] px-1 py-1 text-[#15803D] text-[0.55rem] rounded-full max-w-20 truncate overflow-hidden">${category}</div>
                <p class="text-xs font-semibold text-[#15803D]"><i class="fa-solid fa-bangladeshi-taka-sign fa-xs"></i><span id="price-${id}">${price}</span></p>
